...
# ---------------------------------------------------------------------------
# Trading-day calendar — canonical source: stock_screener.calendar
# Backward-compatible aliases (underscore-prefixed) kept for internal use.
# ---------------------------------------------------------------------------
